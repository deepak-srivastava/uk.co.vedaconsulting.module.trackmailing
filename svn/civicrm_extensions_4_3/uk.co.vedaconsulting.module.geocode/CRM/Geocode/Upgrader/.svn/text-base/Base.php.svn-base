 ...
 */
class CRM_Geocode_Upgrader_Base {
  ...
  static public function instance() {
    if (! self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Geocode_Upgrader(
        'uk.co.vedaconsulting.module.geocode',
        __DIR__ .'/../../../'
      );
    }
   ...
   *
   * @code
   * CRM_Geocode_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
